...
/* RULESETS and ruleset functions are in data-rulesets.js (same folder, loaded before this file) */
...
const CLASSES = [
  {
    ...
    subclasses: [
      { name: 'Path of the Berserker', source: 'PHB', level: 3, description: 'Frenzy drives you to unmatched ferocity in battle.' },
      { name: 'Path of the Totem Warrior', source: 'PHB', level: 3, description: 'The spirits of animals guide and protect you.' }
    ]
  },
  {
    id: 'bard',
    ...
    subclasses: [
      { name: 'College of Lore', source: 'PHB', level: 3, description: 'Bards of the College of Lore know something about most things.' },
      { name: 'College of Valor', source: 'PHB', level: 3, description: 'Bards of the College of Valor are daring skalds.' }
    ]
  },
  {
    id: 'cleric',
    ...
    subclasses: [
      { name: 'Knowledge Domain', source: 'PHB', level: 1, description: 'Gods of knowledge value learning and understanding.' },
      { name: 'Life Domain', source: 'PHB', level: 1, description: 'The Life domain focuses on the vibrant positive energy.' },
      { name: 'Light Domain', source: 'PHB', level: 1, description: 'Gods of light promote the ideals of rebirth and renewal.' },
      { name: 'Nature Domain', source: 'PHB', level: 1, description: 'Gods of nature are as varied as the natural world.' },
      { name: 'Tempest Domain', source: 'PHB', level: 1, description: 'Gods whose portfolios include the tempest.' },
      { name: 'Trickery Domain', source: 'PHB', level: 1, description: 'Gods of trickery are mischief-makers and deceivers.' },
      { name: 'War Domain', source: 'PHB', level: 1, description: 'War has many manifestations.' }
    ]
  },
  {
    id: 'druid',
    ...
    subclasses: [
      { name: 'Circle of the Land', source: 'PHB', level: 2, description: 'The Circle of the Land is made up of mystics and sages.' },
      { name: 'Circle of the Moon', source: 'PHB', level: 2, description: 'Druids of the Circle of the Moon are fierce guardians.' }
    ]
  },
  {
    id: 'fighter',
    ...
    savingThrows: ['Strength', 'Constitution'],
    subclasses: [
      { name: 'Champion', source: 'PHB', level: 3, description: 'The archetypal Champion focuses on the development of raw physical power.' },
      { name: 'Battle Master', source: 'PHB', level: 3, description: 'Those who emulate the archetypal Battle Master employ martial techniques.' },
      { name: 'Eldritch Knight', source: 'PHB', level: 3, description: 'The archetypal Eldritch Knight combines the martial mastery of the fighter with spellcasting.' }
    ]
  },
  {
    id: 'monk',
    ...
    subclasses: [
      { name: 'Way of the Open Hand', source: 'PHB', level: 3, description: 'Monks of the Way of the Open Hand are the ultimate masters of martial arts.' },
      { name: 'Way of Shadow', source: 'PHB', level: 3, description: 'Monks of the Way of Shadow follow a tradition that values stealth and subterfuge.' },
      { name: 'Way of the Four Elements', source: 'PHB', level: 3, description: 'You follow a monastic tradition that teaches you to harness the elements.' }
    ]
  },
  {
    id: 'paladin',
    ...
    savingThrows: ['Wisdom', 'Charisma'],
    subclasses: [
      { name: 'Oath of Devotion', source: 'PHB', level: 3, description: 'The Oath of Devotion binds a paladin to the loftiest ideals of justice.' },
      { name: 'Oath of the Ancients', source: 'PHB', level: 3, description: 'The Oath of the Ancients is as old as the race of elves.' },
      { name: 'Oath of Vengeance', source: 'PHB', level: 3, description: 'The Oath of Vengeance is a solemn commitment to punish those who have committed a grievous sin.' }
    ]
  },
  {
    id: 'ranger',
    ...
    savingThrows: ['Strength', 'Dexterity'],
    subclasses: [
      { name: 'Hunter', source: 'PHB', level: 3, description: 'Emulating the Hunter archetype means accepting your place as a bulwark against the terrors of the wilderness.' },
      { name: 'Beast Master', source: 'PHB', level: 3, description: 'The Beast Master archetype embodies a friendship between the civilized races and the beasts of the world.' }
    ]
  },
  {
    id: 'rogue',
    ...
    subclasses: [
      { name: 'Thief', source: 'PHB', level: 3, description: 'You hone your skills in the larcenous arts.' },
      { name: 'Assassin', source: 'PHB', level: 3, description: 'You focus your training on the grim art of death.' },
      { name: 'Arcane Trickster', source: 'PHB', level: 3, description: 'Some rogues enhance their fine-honed skills of stealth and agility with magic.' }
    ]
  },
  {
    id: 'sorcerer',
    ...
    subclasses: [
      { name: 'Draconic Bloodline', source: 'PHB', level: 1, description: 'Your innate magic comes from draconic magic that was mingled with your blood.' },
      { name: 'Wild Magic', source: 'PHB', level: 1, description: 'Your innate magic comes from the wild magic of chaos.' }
    ]
  },
  {
    id: 'warlock',
    ...
    savingThrows: ['Wisdom', 'Charisma'],
    subclasses: [
      { name: 'The Archfey', source: 'PHB', level: 1, description: 'Your patron is a lord or lady of the fey.' },
      { name: 'The Fiend', source: 'PHB', level: 1, description: 'You have made a pact with a fiend from the lower planes.' },
      { name: 'The Great Old One', source: 'PHB', level: 1, description: 'Your patron is a mysterious entity whose nature is utterly foreign to the fabric of reality.' }
    ]
  },
  {
    id: 'wizard',
    ...
    savingThrows: ['Intelligence', 'Wisdom'],
    subclasses: [
      { name: 'School of Evocation', source: 'PHB', level: 2, description: 'You focus your study on magic that creates powerful elemental effects.' },
      { name: 'School of Illusion', source: 'PHB', level: 2, description: 'You focus your studies on magic that dazzles the senses.' },
      { name: 'School of Necromancy', source: 'PHB', level: 2, description: 'The School of Necromancy explores the cosmic forces of life, death, and undeath.' },
      { name: 'School of Abjuration', source: 'PHB', level: 2, description: 'The School of Abjuration emphasizes magic that blocks, banishes, or protects.' },
      { name: 'School of Conjuration', source: 'PHB', level: 2, description: 'As a conjurer, you favor spells that produce objects and creatures out of thin air.' },
      { name: 'School of Divination', source: 'PHB', level: 2, description: 'The counsel of a diviner is sought by royalty and commoners alike.' },
      { name: 'School of Enchantment', source: 'PHB', level: 2, description: 'As a member of the School of Enchantment, you have honed your ability to magically entrance and beguile.' },
      { name: 'School of Transmutation', source: 'PHB', level: 2, description: 'You are a student of spells that modify energy and matter.' }
    ]
  }
];
...
// ========== BACKGROUNDS ==========
const BACKGROUNDS = [
  { name: 'Acolyte', source: 'PHB', skillProficiencies: ['Insight', 'Religion'], description: 'You have spent your life in the service of a temple.' },
  { name: 'Charlatan', source: 'PHB', skillProficiencies: ['Deception', 'Sleight of Hand'], description: 'You have always had a way with people.' },
  { name: 'City Watch', source: 'PHB', skillProficiencies: ['Athletics', 'Insight'], description: 'You served in the city watch, keeping the peace.' },
  { name: 'Criminal', source: 'PHB', skillProficiencies: ['Deception', 'Stealth'], description: 'You are an experienced criminal with a history of breaking the law.' },
  { name: 'Entertainer', source: 'PHB', skillProficiencies: ['Acrobatics', 'Performance'], description: 'You thrive in front of an audience.' },
  { name: 'Folk Hero', source: 'PHB', skillProficiencies: ['Animal Handling', 'Survival'], description: 'You come from a humble social rank.' },
  { name: 'Gladiator', source: 'PHB', skillProficiencies: ['Athletics', 'Performance'], description: 'You fought for sport and entertainment in the arena.' },
  { name: 'Guild Artisan', source: 'PHB', skillProficiencies: ['Insight', 'Persuasion'], description: 'You are a member of an artisan\'s guild.' },
  { name: 'Hermit', source: 'PHB', skillProficiencies: ['Medicine', 'Religion'], description: 'You lived in seclusion for a formative part of your life.' },
  { name: 'Knight', source: 'PHB', skillProficiencies: ['History', 'Persuasion'], description: 'You belong to an order of knights who have sworn oaths.' },
  { name: 'Noble', source: 'PHB', skillProficiencies: ['History', 'Persuasion'], description: 'You understand wealth, power, and privilege.' },
  { name: 'Outlander', source: 'PHB', skillProficiencies: ['Athletics', 'Survival'], description: 'You grew up in the wilds, far from civilization.' },
  { name: 'Pirate', source: 'PHB', skillProficiencies: ['Athletics', 'Perception'], description: 'You sailed the seas as a pirate or privateer.' },
  { name: 'Sage', source: 'PHB', skillProficiencies: ['Arcana', 'History'], description: 'You spent years learning the lore of the multiverse.' },
  { name: 'Sailor', source: 'PHB', skillProficiencies: ['Athletics', 'Perception'], description: 'You sailed on a seagoing vessel for years.' },
  { name: 'Soldier', source: 'PHB', skillProficiencies: ['Athletics', 'Intimidation'], description: 'War has been your life for as long as you care to remember.' },
  { name: 'Spy', source: 'PHB', skillProficiencies: ['Deception', 'Stealth'], description: 'You worked as a spy or informant for a faction.' },
  { name: 'Urchin', source: 'PHB', skillProficiencies: ['Sleight of Hand', 'Stealth'], description: 'You grew up on the streets, surviving by your wits.' },
  { name: 'Courtier', source: 'PHB', skillProficiencies: ['Insight', 'Persuasion'], description: 'You move in noble circles and understand courtly intrigue.' },
  { name: 'Far Traveler', source: 'PHB', skillProficiencies: ['Insight', 'Perception'], description: 'You come from a distant land with strange customs.' },
  { name: 'Mercenary Veteran', source: 'PHB', skillProficiencies: ['Athletics', 'Persuasion'], description: 'You served in a mercenary company for years.' },
  { name: 'Guild Merchant', source: 'PHB', skillProficiencies: ['Insight', 'Persuasion'], description: 'You are a member of a guild that trades in goods.' },
  { name: 'Inheritor', source: 'PHB', skillProficiencies: ['Survival', 'One of your choice'], description: 'You inherited something from an ancestor.' },
  { name: 'Clan Crafter', source: 'PHB', skillProficiencies: ['History', 'Insight'], description: 'You are a skilled artisan in a dwarven clan.' },
  { name: 'Cloistered Scholar', source: 'PHB', skillProficiencies: ['History', 'One of Arcana/Nature/Religion'], description: 'You spent your life in libraries and scriptoriums.' },
  { name: 'Entertainer (Gladiator)', source: 'PHB', skillProficiencies: ['Acrobatics', 'Performance'], description: 'You fought for sport and entertainment in the arena.' },
  { name: 'Faceless', source: 'PHB', skillProficiencies: ['Deception', 'Intimidation'], description: 'You hide your identity behind masks or magic.' },
  { name: 'Investigator', source: 'PHB', skillProficiencies: ['Investigation', 'One of Insight/Religion'], description: 'You solved mysteries and tracked down criminals.' },
  { name: 'Urban Bounty Hunter', source: 'PHB', skillProficiencies: ['Choose two from Deception, Insight, Persuasion, Stealth'], description: 'You hunt fugitives in city streets.' }
];
...
const WEAPONS = [
  ...
  { name: 'Greataxe', type: 'melee', damage: '1d12', damageType: 'Slashing', range: '5 ft', properties: 'Heavy, two-handed', mastery: 'Topple' },
  { name: 'Greatsword', type: 'melee', damage: '2d6', damageType: 'Slashing', range: '5 ft', properties: 'Heavy, two-handed', mastery: 'Sap' },
  { name: 'Halberd', type: 'melee', damage: '1d10', damageType: 'Slashing', range: '5 ft', properties: 'Heavy, reach, two-handed', mastery: 'Cleave' },
  { name: 'Lance', type: 'melee', damage: '1d12', damageType: 'Piercing', range: '5 ft', properties: 'Reach, special' },
  { name: 'Longsword', type: 'melee', damage: '1d8', damageType: 'Slashing', range: '5 ft', properties: 'Versatile (1d10)', mastery: 'Vex' },
  { name: 'Maul', type: 'melee', damage: '2d6', damageType: 'Bludgeoning', range: '5 ft', properties: 'Heavy, two-handed', mastery: 'Topple' },
  ...
  { name: 'Rapier', type: 'melee', damage: '1d8', damageType: 'Piercing', range: '5 ft', properties: 'Finesse', mastery: 'Vex' },
  { name: 'Scimitar', type: 'melee', damage: '1d6', damageType: 'Slashing', range: '5 ft', properties: 'Finesse, light', mastery: 'Nick' },
  { name: 'Shortsword', type: 'melee', damage: '1d6', damageType: 'Piercing', range: '5 ft', properties: 'Finesse, light', mastery: 'Vex' },
...
// SRD Feats: name, prerequisite, description
const FEATS = [
  { name: 'Alert', prerequisite: '', description: 'You can\'t be surprised while conscious. +5 to initiative. No advantage for hidden attackers.' },
  { name: 'Athlete', prerequisite: '', description: 'Stand from prone using 5 ft. of movement. No penalty for climbing. Running long jump: +5 ft.' },
  { name: 'Actor', prerequisite: '', description: '+1 Charisma (max 20). Advantage on Deception and Performance. Mimic speech and sounds.' },
  { name: 'Charger', prerequisite: '', description: 'Dash and make one weapon attack or shove as bonus action. Attack: +5 damage. Shove: push 10 ft.' },
  { name: 'Crossbow Expert', prerequisite: '', description: 'No disadvantage for ranged attacks within 5 ft. Ignore loading property. Bonus action hand crossbow attack.' },
  { name: 'Defensive Duelist', prerequisite: 'Dex 13+', description: 'When wielding a finesse weapon and hit by melee attack, use reaction to add proficiency to AC.' },
  { name: 'Dual Wielder', prerequisite: '', description: '+1 AC when wielding a separate melee weapon in each hand. Two-weapon fighting with non-light weapons.' },
  { name: 'Durable', prerequisite: '', description: '+1 Constitution (max 20). When rolling Hit Die to heal, minimum = 2 × Con modifier.' },
  { name: 'Elemental Adept', prerequisite: 'Spellcasting', description: 'Spells of chosen damage type ignore resistance. 1s on damage dice become 2s.' },
  { name: 'Grappler', prerequisite: 'Str 13+', description: 'Advantage on attacks vs. grappled creature. Grapple as bonus action. Pin creature (both restrained).' },
  { name: 'Great Weapon Master', prerequisite: '', description: 'Before melee attack with heavy weapon: -5 to hit, +10 damage. On crit or reducing to 0 HP: bonus action attack.' },
  { name: 'Healer', prerequisite: '', description: 'Stabilize with healer\'s kit: restore 1 HP. Heal 1d6+4+level once per rest per creature.' },
  { name: 'Heavily Armored', prerequisite: 'Medium armor proficiency', description: 'Gain heavy armor proficiency. +1 Strength (max 20).' },
  { name: 'Heavy Armor Master', prerequisite: 'Heavy armor proficiency', description: 'While wearing heavy armor, reduce nonmagical bludgeoning, piercing, slashing by 3.' },
  { name: 'Inspiring Leader', prerequisite: 'Cha 13+', description: 'Spend 10 min inspiring up to 6 creatures. They gain temp HP = level + Cha mod. Lasts until rest.' },
  { name: 'Keen Mind', prerequisite: '', description: '+1 Intelligence (max 20). Always know north, hours until sunrise, recall anything seen/heard in past month.' },
  { name: 'Lightly Armored', prerequisite: '', description: 'Gain light armor proficiency. +1 Str or Dex (max 20).' },
  { name: 'Linguist', prerequisite: '', description: '+1 Int (max 20). Learn 3 languages. Create ciphers.' },
  { name: 'Lucky', prerequisite: '', description: '3 luck points per long rest. Spend 1 to reroll d20 (attack, check, save) or force reroll on attacker.' },
  { name: 'Mage Slayer', prerequisite: '', description: 'Reaction to attack spellcaster within 5 ft. Advantage on saves vs. spells from creatures within 5 ft.' },
  { name: 'Magic Initiate', prerequisite: '', description: 'Learn 2 cantrips and 1 1st-level spell from a class. Cast the spell once per long rest.' },
  { name: 'Martial Adept', prerequisite: '', description: 'Learn 2 maneuvers. 1 superiority die (d6). Add to attack damage or use maneuver effect.' },
  { name: 'Mobile', prerequisite: '', description: '+10 ft. speed. Dash: no difficult terrain. Melee attack: no opportunity attack from that target.' },
  { name: 'Moderately Armored', prerequisite: 'Light armor proficiency', description: 'Gain medium armor and shield proficiency. +1 Str or Dex (max 20).' },
  { name: 'Mounted Combatant', prerequisite: '', description: 'Advantage on melee attacks vs. unmounted creatures smaller than mount. Redirect attacks to mount. Mount avoids Dex save damage on success.' },
  { name: 'Observant', prerequisite: '', description: '+1 Wis or Int (max 20). +5 to Passive Perception and Investigation. Read lips.' },
  { name: 'Resilient', prerequisite: '', description: '+1 to one ability (max 20). Gain proficiency in that ability\'s saving throws.' },
  { name: 'Ritual Caster', prerequisite: 'Int or Wis 13+', description: 'Gain ritual book. Copy ritual spells (Int or Wis based). Cast them as rituals.' },
  { name: 'Savage Attacker', prerequisite: '', description: 'Once per turn, reroll weapon damage dice and use either total.' },
  { name: 'Sentinel', prerequisite: '', description: 'Opportunity attacks reduce speed to 0. Creatures within 5 ft. provoke even with Disengage. Reaction attack when ally is hit.' },
  { name: 'Sharpshooter', prerequisite: '', description: 'No disadvantage at long range. Ignore half and three-quarters cover. Before attack: -5 to hit, +10 damage.' },
  { name: 'Shield Master', prerequisite: '', description: 'Bonus action shove with shield. Add shield AC to Dex save for single target. Use reaction to take no damage on Dex save success.' },
  { name: 'Skilled', prerequisite: '', description: 'Gain proficiency in 3 skills or tools.' },
  { name: 'Spell Sniper', prerequisite: 'Spellcasting', description: 'Double spell attack range. Ignore half and three-quarters cover. Learn 1 cantrip with attack roll.' },
  { name: 'Tavern Brawler', prerequisite: '', description: '+1 Str or Con (max 20). Unarmed and improvised weapon proficiency. Grapple as bonus action after unarmed/improvised hit.' },
  { name: 'Tough', prerequisite: '', description: 'HP maximum increases by 2 per level. +40 at 20th level.' },
  { name: 'War Caster', prerequisite: 'Spellcasting or Pact Magic', description: 'Advantage on Con saves for concentration. Cast spells as opportunity attacks. Somatic components with hands full.' },
  { name: 'Weapon Master', prerequisite: '', description: '+1 Str or Dex (max 20). Gain proficiency with 4 weapons of your choice.' }
];
...
/**
 * Create a blank character object with all expected fields and defaults.
 * Used when starting a new character or migrating legacy saves.
...
/** Derive the source of a skill proficiency for display (e.g. "Background: Criminal", "Race: Half-Orc") */
function getSkillSource(skill, char) {
  if (!char || !skill) return null;
  const bg = typeof getMergedBackgrounds === 'function' ? getMergedBackgrounds().find(b => b.name === char.background) : null;
  if (bg?.skillProficiencies) {
    for (const s of bg.skillProficiencies) {
      if (s === skill) return `Background: ${char.background}`;
      const parts = s.split(/[,/]| or |One of |Choose \d+ from /i).map(p => p.replace(/^\[|\]$/g, '').trim()).filter(Boolean);
      if (parts.some(p => p === skill || p.includes(skill))) return `Background: ${char.background}`;
      const chooseMatch = s.match(/Choose \d+ from ([^]+)/i);
      if (chooseMatch) {
        const options = chooseMatch[1].split(/[,/]| and /).map(p => p.trim()).filter(Boolean);
        if (options.some(o => o === skill || o.includes(skill))) return `Background: ${char.background}`;
      }
    }
  }
  const raceSkillGrants = { 'Intimidation': ['Half-Orc', 'Orc'], 'Stealth': ['Lightfoot Halfling', 'Stout Halfling'], 'Perception': ['Elf', 'High Elf', 'Wood Elf'] };
  if (raceSkillGrants[skill]?.includes(char.race) || raceSkillGrants[skill]?.includes(char.subrace))
    return `Race: ${char.subrace || char.race}`;
  const subclassBonus = char.subclass && typeof BONUS_PROFICIENCIES_ON_LEVEL !== 'undefined'
    ? BONUS_PROFICIENCIES_ON_LEVEL[`${char.class}|${char.subclass}`] : null;
  if (subclassBonus && Object.values(subclassBonus).some(v => v?.type === 'skills'))
    return `Subclass: ${char.subclass}`;
  return `Class: ${char.class}`;
}

/**
 * Get languages, resistances, immunities, vulnerabilities, weaknesses from race/subrace.
 * Used to auto-populate step 9 when entering Details step.
 * @param {string} raceName - Race name
 * @param {string} [subraceName] - Subrace name (optional)
 * @returns {Object} { languages, resistances, immunities, vulnerabilities, weaknesses, languagesExtra }
 */
...
const ADDITIONAL_BOOKS = [
  {
    ...
    enabled: true,
    races: [
      { id: 'custom-lineage', name: 'Custom Lineage', source: 'TCoE', description: 'Create a custom lineage using the rules in Tasha\'s.', speed: 30, abilityScore: { any: 2 }, traits: ['Custom', 'Darkvision or Skill'], languages: ['Common'], languagesExtra: 1, subraces: [] }
    ],
    classes: [
      { id: 'artificer', name: 'Artificer', source: 'TCoE', description: 'Masters of invention who use magic to create objects.', hitDie: 8, primaryAbility: ['Intelligence'], savingThrows: ['Constitution', 'Intelligence'], subclasses: [
        { name: 'Alchemist', source: 'TCoE', level: 3, description: 'Alchemists use magic to create potions.' },
        { name: 'Armorer', source: 'TCoE', level: 3, description: 'Armorers craft magical suits of armor.' },
        { name: 'Battle Smith', source: 'TCoE', level: 3, description: 'Battle Smiths bond with a mechanical companion.' }
      ] }
    ],
    backgrounds: [
      { name: 'Feylost', source: 'TCoE', skillProficiencies: ['Deception', 'Survival'], description: 'You were lost in the Feywild as a child.' }
    ],
  ...
  },
  {
    ...
    races: [],
    classes: [
      { name: 'Barbarian', subclasses: [{ name: 'Path of the Storm Herald', source: 'XGtE', level: 3, description: 'Channel the storm.' }] },
      { name: 'Bard', subclasses: [{ name: 'College of Glamour', source: 'XGtE', level: 3, description: 'Bards of the College of Glamour.' }] },
      { name: 'Cleric', subclasses: [{ name: 'Forge Domain', source: 'XGtE', level: 1, description: 'Gods of the forge.' }] },
      { name: 'Druid', subclasses: [{ name: 'Circle of the Shepherd', source: 'XGtE', level: 2, description: 'Spirit of the wild.' }] },
      { name: 'Fighter', subclasses: [{ name: 'Samurai', source: 'XGtE', level: 3, description: 'Elegant warriors.' }] },
      { name: 'Monk', subclasses: [{ name: 'Way of the Kensei', source: 'XGtE', level: 3, description: 'Weapon masters.' }] },
      { name: 'Paladin', subclasses: [{ name: 'Oath of Conquest', source: 'XGtE', level: 3, description: 'Conquer your foes.' }] },
      { name: 'Ranger', subclasses: [{ name: 'Gloom Stalker', source: 'XGtE', level: 3, description: 'Hunters in the dark.' }] },
      { name: 'Rogue', subclasses: [{ name: 'Scout', source: 'XGtE', level: 3, description: 'Skilled hunters.' }] },
      { name: 'Sorcerer', subclasses: [{ name: 'Divine Soul', source: 'XGtE', level: 1, description: 'Celestial power.' }] },
      { name: 'Warlock', subclasses: [{ name: 'The Celestial', source: 'XGtE', level: 1, description: 'Healing light.' }] },
      { name: 'Wizard', subclasses: [{ name: 'War Magic', source: 'XGtE', level: 2, description: 'Combat magic.' }] }
    ],
    backgrounds: [
      { name: 'Archaeologist', source: 'XGtE', skillProficiencies: ['History', 'Survival'], description: 'You have explored ruins.' },
      { name: 'Knight of the Order', source: 'XGtE', skillProficiencies: ['Persuasion', 'Survival'], description: 'You belong to an order.' }
    ],
  ...
  },
  {
    ...
    enabled: false,
    races: [
      { id: 'goliath', name: 'Goliath', source: 'VGtM', description: 'Large humanoids from mountain regions, known for strength and resilience.', speed: 30, abilityScore: { strength: 2 }, traits: ['Natural Athlete', 'Stone\'s Endurance', 'Powerful Build'], languages: ['Common', 'Giant'], languagesExtra: 0, subraces: [] },
      { id: 'aasimar', name: 'Aasimar', source: 'VGtM', description: 'Humanoids touched by celestial power, often serving as divine emissaries.', speed: 30, abilityScore: { charisma: 2 }, traits: ['Darkvision', 'Celestial Resistance', 'Healing Hands'], languages: ['Common', 'Celestial'], languagesExtra: 0, subraces: [
        { name: 'Protector', source: 'VGtM', abilityScore: { charisma: 2, wisdom: 1 }, traits: ['Radiant Soul'] },
        { name: 'Scourge', source: 'VGtM', abilityScore: { charisma: 2, constitution: 1 }, traits: ['Radiant Consumption'] },
        { name: 'Fallen', source: 'VGtM', abilityScore: { charisma: 2, strength: 1 }, traits: ['Necrotic Shroud'] }
      ] },
      { id: 'firbolg', name: 'Firbolg', source: 'VGtM', description: 'Gentle giants of the forest who prefer solitude and nature.', speed: 30, abilityScore: { wisdom: 2, strength: 1 }, traits: ['Firbolg Magic', 'Hidden Step', 'Powerful Build'], languages: ['Common', 'Elvish', 'Giant'], languagesExtra: 0, subraces: [] }
    ],
    classes: [],
    backgrounds: [],
  ...
  },
  {
    ...
    enabled: false,
    races: [
      { id: 'githyanki', name: 'Githyanki', source: 'MToF', description: 'Warrior race from the Astral Plane, sworn to destroy mind flayers.', speed: 30, abilityScore: { strength: 2, intelligence: 1 }, traits: ['Decadent Mastery', 'Martial Prodigy', 'Githyanki Psionics'], languages: ['Common', 'Gith'], languagesExtra: 0, subraces: [] },
      { id: 'githzerai', name: 'Githzerai', source: 'MToF', description: 'Disciplined monks from Limbo, focused on mental clarity.', speed: 30, abilityScore: { wisdom: 2, intelligence: 1 }, traits: ['Mental Discipline', 'Githzerai Psionics'], languages: ['Common', 'Gith'], languagesExtra: 0, subraces: [] },
      { id: 'eladrin', name: 'Eladrin', source: 'MToF', description: 'Elves of the Feywild whose mood shifts with the seasons.', speed: 30, abilityScore: { dexterity: 2 }, traits: ['Fey Ancestry', 'Trance', 'Fey Step'], languages: ['Common', 'Elvish'], languagesExtra: 0, subraces: [] }
    ],
    classes: [],
    backgrounds: [],
  ...
  },
  {
    ...
    races: [],
    classes: [
      { name: 'Barbarian', subclasses: [{ name: 'Path of the Beast', source: 'FToD', level: 3, description: 'Embrace the beast within.' }] },
      { name: 'Fighter', subclasses: [{ name: 'Rune Knight', source: 'FToD', level: 3, description: 'Harness the power of runes.' }] },
      { name: 'Monk', subclasses: [{ name: 'Way of the Ascendant Dragon', source: 'FToD', level: 3, description: 'Channel draconic power.' }] },
      { name: 'Paladin', subclasses: [{ name: 'Oath of the Watchers', source: 'FToD', level: 3, description: 'Guard against extraplanar threats.' }] },
      { name: 'Ranger', subclasses: [{ name: 'Drakewarden', source: 'FToD', level: 3, description: 'Bond with a draconic spirit.' }] }
    ],
    backgrounds: [],
  ...
  },
  {
    ...
    races: [],
    classes: [
      { name: 'Bard', subclasses: [{ name: 'College of Spirits', source: 'VRGtR', level: 3, description: 'Channel spirits for guidance.' }] },
      { name: 'Cleric', subclasses: [{ name: 'Peace Domain', source: 'VRGtR', level: 1, description: 'Spread harmony and unity.' }] },
      { name: 'Warlock', subclasses: [{ name: 'The Undead', source: 'VRGtR', level: 1, description: 'Pact with an undead patron.' }] },
      { name: 'Wizard', subclasses: [{ name: 'Order of Scribes', source: 'VRGtR', level: 2, description: 'Master of magical writing and spellbooks.' }] }
    ],
    backgrounds: [
      { name: 'Haunted One', source: 'VRGtR', skillProficiencies: ['Investigation', 'Religion'], description: 'You are haunted by something from your past.' }
    ],
  ...
  },
  {
    ...
    enabled: false,
    races: [
      { id: 'duergar', name: 'Duergar', source: 'SCAG', description: 'Gray dwarves of the Underdark, hardened by slavery.', speed: 25, abilityScore: { constitution: 2 }, traits: ['Darkvision', 'Duergar Resilience', 'Sunlight Sensitivity'], languages: ['Common', 'Dwarvish'], languagesExtra: 0, subraces: [] }
    ],
    classes: [
      { name: 'Barbarian', subclasses: [{ name: 'Path of the Battlerager', source: 'SCAG', level: 3, description: 'Berserker in spiked armor.' }] },
      { name: 'Fighter', subclasses: [{ name: 'Purple Dragon Knight', source: 'SCAG', level: 3, description: 'Inspire allies in battle.' }] },
      { name: 'Rogue', subclasses: [{ name: 'Mastermind', source: 'SCAG', level: 3, description: 'Master of tactics and deception.' }] },
      { name: 'Warlock', subclasses: [{ name: 'The Undying', source: 'SCAG', level: 1, description: 'Pact with deathless beings.' }] }
    ],
    backgrounds: [],
  ...
  { id: 'mpmm', name: "Mordenkainen Presents: Monsters of the Multiverse", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Updated races and monsters from Volo\'s and Mordenkainen\'s.' },
  { id: 'ggr', name: "Guildmaster's Guide to Ravnica", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Ravnica setting.' },
  { id: 'erlw', name: "Eberron: Rising from the Last War", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Eberron setting.' },
  { id: 'egw', name: "Explorer's Guide to Wildemount", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Critical Role setting.' },
  { id: 'mot', name: "Mythic Odysseys of Theros", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Theros setting.' },
  { id: 'scc', name: "Strixhaven: Curriculum of Chaos", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Strixhaven setting.' },
  { id: 'aag', name: "Astral Adventurer's Guide", edition: '5e', enabled: false, races: [], classes: [], backgrounds: [], rules: 'Spelljammer setting.' }
];
...
function getActiveEdition() {
  return localStorage.getItem('dnd_edition') || '5e';
}
function setActiveEdition(ed) {
  localStorage.setItem('dnd_edition', ed);
}

// ========== HOMEBREW CONTENT ==========
function getHomebrewContent() {
  try {
    const s = localStorage.getItem('dnd_homebrew_content');
    if (s) return JSON.parse(s);
  } catch (e) {}
  return { races: [], classes: [], backgrounds: [], feats: [] };
}
function setHomebrewContent(data) {
  try {
    const obj = { races: data.races || [], classes: data.classes || [], backgrounds: data.backgrounds || [], feats: data.feats || [] };
    localStorage.setItem('dnd_homebrew_content', JSON.stringify(obj));
    return true;
  } catch (e) { return false; }
}

// ========== MERGED CONTENT (ruleset + edition filtered) ==========
/**
 * Get races available for selection, filtered by edition and ruleset.
 * Merges SRD, additional books, custom races, and homebrew.
...
function getMergedRaces() {
  ...
  let races;
  if (edition === '5.5e') {
    races = typeof RACES_2024 !== 'undefined' ? [...RACES_2024] : [];
  } else {
    races = [...RACES, ...getCustomRaces()];
    const enabledBooks = typeof getEnabledAdditionalBooks === 'function' ? getEnabledAdditionalBooks() : [];
    ADDITIONAL_BOOKS.filter(b => (b.enabled || enabledBooks.includes(b.id)) && b.races && (!b.edition || b.edition === '5e')).forEach(book => {
      book.races.forEach(r => {
        if (!races.find(ex => ex.name === r.name)) races.push({ ...r, source: r.source || book.id });
      });
    });
  ...
  const homebrew = getHomebrewContent();
  (homebrew.races || []).forEach(r => { if (r && r.name && !races.find(ex => ex.name === r.name)) races.push({ ...r, source: r.source || 'homebrew' }); });
  return races;
}

/**
 * Get classes available for selection, filtered by edition and ruleset.
 * Merges SRD, additional books, and homebrew classes/subclasses.
...
function getMergedClasses() {
  ...
  let classes;
  if (edition === '5.5e') {
    classes = typeof CLASSES_2024 !== 'undefined' ? JSON.parse(JSON.stringify(CLASSES_2024)) : [];
  } else {
    classes = JSON.parse(JSON.stringify(CLASSES));
    const enabledBooks = typeof getEnabledAdditionalBooks === 'function' ? getEnabledAdditionalBooks() : [];
    ADDITIONAL_BOOKS.filter(b => (b.enabled || enabledBooks.includes(b.id)) && b.classes && (!b.edition || b.edition === '5e')).forEach(book => {
      book.classes.forEach(cls => {
        ...
        if (existing && cls.subclasses?.length) {
          ...
          classes.push({ ...cls, source: cls.source || book.id });
        }
      });
    });
    const filter = getMergedRulesetFilter();
  ...
  const homebrew = getHomebrewContent();
  (homebrew.classes || []).forEach(cls => {
    const existing = classes.find(c => c.name === cls.name);
    if (existing && cls.subclasses?.length) { existing.subclasses = [...(existing.subclasses || []), ...cls.subclasses]; }
    else if (!existing && cls.name) classes.push({ ...cls, source: cls.source || 'homebrew' });
  });
  return classes;
}

/**
 * Get backgrounds available for selection, filtered by edition and ruleset.
 * Merges SRD, additional books, custom backgrounds, and homebrew.
...
function getMergedBackgrounds() {
  ...
  let bgs;
  if (edition === '5.5e') {
    bgs = typeof BACKGROUNDS_2024 !== 'undefined' ? [...BACKGROUNDS_2024] : [];
  } else {
    bgs = [...BACKGROUNDS, ...getCustomBackgrounds()];
    const enabledBooks = typeof getEnabledAdditionalBooks === 'function' ? getEnabledAdditionalBooks() : [];
    ADDITIONAL_BOOKS.filter(b => (b.enabled || enabledBooks.includes(b.id)) && b.backgrounds && (!b.edition || b.edition === '5e')).forEach(book => {
      book.backgrounds.forEach(bg => {
        if (!bgs.find(ex => ex.name === bg.name)) bgs.push({ ...bg, source: bg.source || book.id });
      });
    });
    const filter = getMergedRulesetFilter();
  ...
  const homebrew = getHomebrewContent();
  (homebrew.backgrounds || []).forEach(bg => { if (bg && bg.name && !bgs.find(ex => ex.name === bg.name)) bgs.push({ ...bg, source: bg.source || 'homebrew' }); });
  return bgs;
}
